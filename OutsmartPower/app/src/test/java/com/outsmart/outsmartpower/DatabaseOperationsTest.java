...
//      TODO  DatabaseOperations Db = DatabaseOperations.getInstance();
//        PowerRecord record = new PowerRecord(new DateManager(1485626052),1.1,2.2,3.3,4.4,240.4,222);
//        Db.addDataRecord(record);
//        TODO List<PowerRecord> records = Db.getAllRecordsInRange(222,DateManager.getTodayMidnightSeconds());
//        double expected = 1.1;
